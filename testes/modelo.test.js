...
test('Testando cadastro de três respostas', () => {
  const id_pergunta = modelo.cadastrar_pergunta('3 * 27 = ?');
  const id_resposta = modelo.cadastrar_resposta(id_pergunta, '81');
...
test('Testando get_pergunta', () => {
  const id_pergunta = modelo.cadastrar_pergunta('9 * 9 = ?');
